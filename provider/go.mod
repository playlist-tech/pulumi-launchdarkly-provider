module github.com/playlist-tech/pulumi-launchdarkly/provider
...
require (
	github.com/launchdarkly/terraform-provider-launchdarkly v1.7.2-0.20260420110248-18963471fcd9
